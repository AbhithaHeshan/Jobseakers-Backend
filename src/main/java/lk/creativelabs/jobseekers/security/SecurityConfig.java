...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(GET,"/jobApplication/get/byId").permitAll();
        http.authorizeRequests().antMatchers(POST,"/jobApplication/update/status").permitAll();

        http.authorizeRequests().antMatchers(POST,"/works/create/new/works").permitAll();
        http.authorizeRequests().antMatchers(GET,"/works/getSubmittedWorks/**").permitAll();
        http.authorizeRequests().antMatchers(POST,"/works/submitted/works").permitAll();
        http.authorizeRequests().antMatchers(GET,"/works/get/works").permitAll();
        http.authorizeRequests().antMatchers(GET,"/works/getSubmittedWorks").permitAll();
        http.authorizeRequests().antMatchers(POST,"/works/mark/**").permitAll();
        http.authorizeRequests().antMatchers(GET,"/works/mark/**").permitAll();
        http.authorizeRequests().antMatchers(GET,"/works/get/all/dataBy").permitAll();
        ...
        http.authorizeRequests().antMatchers(GET,"/works/get/specific/clients").permitAll();
